...
/* A forma tradicional com que o JAvaScript lida com objetos não permite o controle sobre sua criação nem sobre o seu conteúdo.
Os objetos funcionam baseados estritamente no "controle de qualidade" feito pelo usuário/programador.
*/
