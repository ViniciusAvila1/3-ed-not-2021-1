...
//function DensDemo (area, populacao) {
...
let ordemA = []
ordemA.push(estado1.nome)
ordemA.unshift(estado2.nome)
ordemA.splice(1, 0, estado3.nome) // Rio Grande do Norte entre os dois
ordemA.splice(1, 0, estado4.nome) // Pernambuco antes de RN
ordemA.splice(2, 0, estado5.nome) // Paraíba antes de Pernambuco
ordemA.splice(1, 0, estado6.nome) // Ceará entre Alagoas e Pernambuco
ordemA.splice(4, 0, estado7.nome) // Piauí entre PE e RN
ordemA.splice(2, 0, estado8.nome) // Maranhão após Ceará
ordemA.splice(1, 0, estado9.nome) // Bahia após Alagoas
